...
if (!fs.existsSync('/home/pi/mos-google-libs/devices.json')){
  console.log('devices.json was not found!');
  process.exit(1);
}
// Import Devices.json as an object
console.log('\nLoaded .json file with your Zigbee devices.\n');
var zigbeeDevices = JSON.parse(fs.readFileSync('/home/pi/mos-google-libs/devices.json')); // Holds registered Zigbee Devices
